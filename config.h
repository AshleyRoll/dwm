...
static char *fonts[]          = { "monospace:size=12", "JoyPixels:pixelsize=14:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_w,		spawn,		{.v = (const char*[]){ BROWSER, "--profile-directory=Default", NULL } } },
